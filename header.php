        ...
        <header class="header">
            <div class="desktop-menu">
                <div class="header-top">
                    <div class="container">
                        <div class="top-left">
                            <p>YẾN SÀO ĐẠI AN - SỨC KHỎE VÀNG TRAO NGÀN YÊU THƯƠNG</p>
                        </div>
                        <div class="top-right">
                            <ul>
                                <li>
                ...
                <div class="header-bottom">
                    <div class="container">
                        <div class="menu-wrap">
                            <div class="menu-wrap-moblie" style="display: none;"></div>
                            <ul>
                                <li>
                                    <a href=""> TRANG CHỦ </a>
                                </li>
                                ...
                                <li class="li4">
                                    <a href="">CẨM NANG <i class="far fa-angle-down" style="color: #ffffff;"></i>
                                    </a>
                                    <ul class="ul4">
                                        <li> <a href=""> Cẩm mang sức khỏe vàng </a></li>
                                        <li> <a href=""> Kinh nghiệm</a></li>
                                        <li> <a href=""> Hướng dẫn sử dụng và bảo quản</a></li>
                                    </ul>
                                </li>
                                <li class="li5">
                                    <a href=""> TIN TỨC <i class="far fa-angle-down" style="color: #ffffff;"></i>
                                    </a>
                                    <ul class="ul5">
                                        <li> <a href=""> Tin tức về công ty</a></li>
                                        <li> <a href=""> Tin tức về ngành yến</a></li>
